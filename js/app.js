const APP = {
  ...
  changeDisplay: () => {
    if (APP.isOnline) {
      ...
      document.querySelector('.isonline').textContent = "finally";
      document.querySelector('img').src = 'img/awake.jpg'
    } else {
      document.body.classList.add('offline')
      document.querySelector('.isonline').textContent = "NO LONGER";
      document.querySelector('img').src = 'img/isleep.jpg'
    }
  },
  gotMessage: (ev) => {
